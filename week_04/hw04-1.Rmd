...
> 在資料中包含很多數理成績，以及讀書環境或家長因素，首先想先找出哪些科目和性別有關係，然後再慢慢加進其他的變因，來完成模型的建立。
...
從圖中可以推測，閱讀書量影響了成績，而女生的地科成績，普遍比男生差。
...
```{r}
fit_m2 <- data.frame(data[, c(1, 6, 2)], fitted = fitted(m2), resid = resid(m2),
